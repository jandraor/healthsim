...
# Test case: Entire run with orders at time 0
...
countries_template <- read_csv("./R_Models/games/game_1/tests/model_tests/test_cases/single_order_manual_init_entire_run/countries.csv", col_types = cols())
write_csv(countries_template, "./R_Models/games/game_1/model/data/Countries.csv")
countries_mock_up <- read_csv("./R_Models/games/game_1/tests/model_tests/test_cases/single_order_manual_init_entire_run/Countries_MOCKUP.csv", col_types = cols())
